...
function StarRating() {
    return (
        <div className="flex items-center gap-1 mt-1">
            {[...Array(5)].map((_, i) => (
                <svg key={i} className="w-4 h-4 text-[#fbbb45] fill-current" viewBox="0 0 20 20">
...
export function Stats() {
    ...
    return (
        <div className="py-16 bg-[#2c1c11] relative">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-8 md:gap-12 lg:gap-16">
                    {stats.map((stat, index) => (
                        ...
                        >
                            ...
                            <p className="text-sm text-[#a58b88] mt-2 uppercase tracking-wider font-medium">
                                {stat.label}
                            </p>
                        </motion.div>
                    ))}
