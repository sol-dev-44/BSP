        ...
        <main className="min-h-screen bg-[#1e1006] text-[#fbddca]">
            ...
            <div className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
                ...
                <div className="absolute inset-0 overflow-hidden pointer-events-none">
                    <div className="absolute top-20 left-10 w-72 h-72 bg-[#ffb3ad]/15 rounded-full blur-3xl animate-pulse" />
                    <div className="absolute bottom-10 right-10 w-96 h-96 bg-[#fbbb45]/15 rounded-full blur-3xl animate-pulse delay-1000" />
                </div>
                ...
                <div className="max-w-4xl mx-auto text-center relative z-10">
                    ...
                    <motion.p
                        ...
                        className="text-xl md:text-2xl text-[#ddc0bd] max-w-2xl mx-auto leading-relaxed"
                    >
                    ...
                    <motion.div
                        ...
                        className="mt-4 text-[#a58b88] font-medium"
                    >
                    ...
                    <motion.a
                        ...
                        className="inline-flex items-center gap-2 mt-10 px-10 py-4 rounded-full bg-[#ffb3ad] text-[#640c0f] font-black text-lg shadow-xl hover:shadow-[#ffb3ad]/40 hover:scale-105 transition-all duration-300"
                    >
            ...
            {/* Three Roles */}
            <div className="py-16 px-4 sm:px-6 lg:px-8 bg-[#28180d]">
                <div className="max-w-6xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-xl text-[#ddc0bd] max-w-2xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {ROLES.map((role, i) => (
                            <motion.div
                                ...
                                className="bg-[#2c1c11] rounded-xl p-8 shadow-xl transition-all duration-300 group"
                            >
                                <div className={`inline-flex p-4 rounded-2xl bg-gradient-to-r ${role.color} shadow-lg mb-6 group-hover:shadow-xl transition-shadow`}>
                                    <role.icon className="h-7 w-7 text-[#640c0f]" />
                                </div>
                                <h3 className="text-2xl font-black mb-5 text-[#fbddca]">{role.title}</h3>
                                <ul className="space-y-3">
                                    {role.what.map((item, j) => (
                                        <li key={j} className="flex items-start gap-3">
                                            ...
                                            <span className="text-[#ddc0bd] text-sm leading-relaxed">{item}</span>
                                        </li>
                                    ))}
                                </ul>
                            </motion.div>
            ...
            <div className="py-20 px-4 sm:px-6 lg:px-8 bg-[#1e1006]">
                <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
                    ...
                    >
                        ...
                        <ul className="space-y-4">
                            {LOOKING_FOR.map((item, i) => (
                                <li key={i} className="flex items-start gap-3 text-[#ddc0bd]">
                                    <div className="w-6 h-6 rounded-full bg-[#ffb3ad]/10 text-[#ffb3ad] flex items-center justify-center flex-shrink-0 mt-0.5">
                        ...
                        <p className="mt-6 text-[#a58b88] text-sm italic">
                    ...
                    <motion.div
                        ...
                        className="space-y-6"
                    >
                        <div className="bg-[#2c1c11] rounded-xl p-8 shadow-xl">
                            <h3 className="text-2xl font-black mb-6 text-[#fbddca]">Why This Job Hits Different</h3>
                            <div className="space-y-5">
                                {PERKS.map((perk, i) => (
                                    <div key={i} className="flex items-center gap-4">
                                        <div className="p-2.5 rounded-xl bg-gradient-to-r from-[#ffb3ad]/10 to-[#fbbb45]/10 text-[#ffb3ad] flex-shrink-0">
                                            <perk.icon className="w-5 h-5" />
                                        </div>
                                        <span className="text-[#ddc0bd] font-medium">{perk.text}</span>
                                    </div>
                                ))}
                            </div>
                        </div>

                        <div className="bg-[#2c1c11] rounded-xl p-8">
                            <h3 className="text-xl font-black mb-4 text-[#fbddca]">By End of Season You&apos;ll Have...</h3>
                            <ul className="space-y-3 text-[#ddc0bd] text-sm">
                                {[
                                    ...
                                    <li key={i} className="flex items-start gap-2">
                                        <span className="text-[#ffb3ad] font-bold mt-0.5">&rarr;</span>
                                        {item}
                                    </li>
                                ))}
                            </ul>
            ...
            {/* Apply CTA */}
            <div className="py-20 px-4 sm:px-6 lg:px-8 bg-[#28180d]">
                <div className="max-w-3xl mx-auto">
                    <motion.div
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                        className="bg-[#2c1c11] rounded-[2rem] p-10 md:p-14 text-center relative overflow-hidden"
                    >
                        <div className="absolute top-0 right-0 w-40 h-40 bg-[#ffb3ad]/15 rounded-full blur-3xl translate-x-1/2 -translate-y-1/2 pointer-events-none" />

                        <h2 className="text-4xl font-black uppercase tracking-tighter mb-4 font-[family-name:var(--font-headline)]">Sound Like You?</h2>
                        <p className="text-xl text-[#ddc0bd] mb-8 max-w-xl mx-auto leading-relaxed">
                        ...
                        <a
                            href="mailto:bigskyparasailing@gmail.com"
                            className="inline-flex items-center gap-3 px-10 py-5 rounded-full bg-[#ffb3ad] text-[#640c0f] font-black text-xl shadow-2xl hover:shadow-[#ffb3ad]/40 hover:scale-105 transition-all duration-300"
                        >
                            <Mail className="w-6 h-6" />
                            bigskyparasailing@gmail.com
                        </a>

                        <p className="mt-8 text-sm text-[#a58b88]">
