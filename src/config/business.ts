...
export const BUSINESS_INFO = {
    ...
    services: [
        ...
        },
        {
            ...
            tagline: 'Photos + Video - Save $10',
            description: 'Get the best of both worlds with our combo media package. Includes professional HD photos and GoPro video of your flight over Flathead Lake. Save $10 versus buying separately.',
            features: [
                'HD photo package',
        ...
        {
            id: 'gopro',
            name: 'GoPro 9 Experience',
            price: 40,
            image: 'https://qcohcaavhwujvagmpbdp.supabase.co/storage/v1/object/public/bsp-images//HighAerial.jpeg',
            tagline: 'Immersive flight footage',
            description: 'Capture your flight in immersive video with stunning aerial footage over Flathead Lake and the surrounding Montana mountains.',
            features: [
                'GoPro 9 video capture',
