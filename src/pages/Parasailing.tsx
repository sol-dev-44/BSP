  ...
  "additionalProperty": [
    {
      "@type": "PropertyValue",
      "name": "Experience",
      "value": "15+ years in parasailing",
    },
    {
      "@type": "PropertyValue",
      "name": "Safety Record",
      "value": "100% Perfect safety record",
    },
    {
      "@type": "PropertyValue",
      "name": "Certification",
      "value": "USCG certified captains",
    },
  ],
};
...
const AboutPage = () => {
  return (
    <>
      <SEO
        title="About Big Sky Parasail | Montana Parasailing Experience"
        ...
        <div className="relative bg-gradient-to-r from-blue-600 to-cyan-500 text-white">
          ...
          <div className="container mx-auto px-4 py-20 md:py-32 relative z-10">
            ...
            >
              ...
              >
                Montana's premier parasailing adventure on the breathtaking
                Flathead Lake
              </motion.p>
            </motion.div>
          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                >
                  Established in 2022, Big Sky Parasail emerged from a vision to
                  showcase Montana's magnificent landscapes from a truly unique
                  perspective. Our founders recognized the untapped potential of
                  Flathead Lake as the perfect setting for world-class
                ...
                <motion.p
                  ...
                  className="text-gray-700 mb-4"
                >
                  With extensive experience in water sports and a deep
                  appreciation for Montana's natural beauty, our team carefully
                  developed an operation centered around safety, accessibility,
                  and unforgettable experiences. We're proud to be the premier
                  parasailing adventure on Montana's largest natural freshwater
                  lake.
                </motion.p>
                <motion.div
                  variants={fadeInUp}
                ...
                >
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      ...
                      <span>
                        USCG certified captains with 15+ years of Parasailing
                    ...
                    <li className="flex items-start">
                      ...
                      <span>
                        Adhere to Water Sports Industry Association Standards
                      </span>
                    </li>
                    <li className="flex items-start">
                      <svg
                    ...
                    <li className="flex items-start">
                      ...
                      <span>
                        Montana-based operation, deeply connected to the local
                        community
                      </span>
                    </li>
                  </ul>
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              >
                Discover why our unique location offers one of the most
                spectacular parasailing experiences in the country.
              </motion.p>
            </motion.div>
              ...
              >
                ...
                >
                  ...
                  <p className="text-gray-700">
                    Nestled in the heart of northwest Montana, Flathead Lake
                    spans an impressive 197 square miles, making it the largest
                    natural freshwater lake west of the Mississippi. With
                    crystal-clear waters reaching depths of up to 370 feet, this
                    glacial wonder provides the ideal backdrop for your
                ...
                >
                  ...
                  <p className="text-gray-700">
                    The lake's pristine waters, consistent summer breezes, and
                    relatively protected position create perfect flying
                    conditions for parasailing adventures. From above, you might
                    spot Wild Horse Island, ancient shorelines, and on clear
                    days, even glimpses of Glacier National Park in the
                    distance.
                  </p>
                </motion.div>
                <motion.div
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                    <div className="bg-gray-50 p-3 rounded-lg">
                      ...
                      <p className="text-sm text-gray-600">
                        Snowcapped peaks, vibrant green landscapes
                      </p>
                    </div>
                    <div className="bg-gray-50 p-3 rounded-lg">
                      <p className="font-semibold text-amber-500">
                      ...
                      <p className="text-sm text-gray-600">
                        Warm temperatures, perfect visibility
                      </p>
                    </div>
                    <div className="bg-gray-50 p-3 rounded-lg">
                      <p className="font-semibold text-amber-500">
                      ...
                      <p className="text-sm text-gray-600">
                        Spectacular autumn foliage, peaceful conditions
                      </p>
                    </div>
                  </div>
                </motion.div>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              >
                At Big Sky Parasail, safety isn't just a priority—it's our
                foundation. Our operation adheres to rigorous industry standards
                and employs best practices developed from decades of parasailing
                experience.
              </motion.p>
                ...
                >
                  ...
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-start">
                      ...
                      <span>
                        Premium harnesses with additional back support
                      </span>
                    </li>
                    <li className="flex items-start">
                      <svg
                      ...
                      <span>
                        Marine-grade, commercial parasail canopies inspected
                        daily
                      </span>
                    </li>
                  </ul>
                ...
                >
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      ...
                      <span>
                        USCG certified captains with extensive training
                      </span>
                    </li>
                    <li className="flex items-start">
                      <svg
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <motion.p
                ...
                className="text-gray-600 max-w-3xl mx-auto"
              >
                Beyond thrilling adventures, we're dedicated to creating
                memorable experiences through exceptional service and
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                ...
                <p className="text-gray-700 mb-4 text-center">
                  We believe in creating more than just a thrill—we're crafting
                  lasting memories. From your first contact with us to the final
                  landing, our team is dedicated to exceeding your expectations.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-700 mb-4 text-center">
                  Flathead Lake's pristine waters and surrounding wilderness are
                  treasures we're committed to preserving. Our operations are
                  designed to minimize environmental impact while promoting
                  appreciation for this unique ecosystem.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-700 mb-4 text-center">
                  As a Montana-based business, we're proud to be part of the
                  Flathead Valley community. We work closely with local
                  businesses and organizations to create a positive impact
                  beyond our parasailing operations.
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl italic mb-6 text-center">
                "The most breathtaking experience of our Montana vacation. The
                views of the mountains and lake were spectacular, and the crew
                made us feel safe the entire time. Worth every penny!"
              </p>
        ...
        <section className="py-16 bg-gradient-to-r from-blue-600 to-cyan-500 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              >
                Book your parasailing adventure today and see Flathead Lake from
                a perspective few ever will.
              </motion.p>
