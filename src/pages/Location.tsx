...
const AttractionCard = ({ title, description, distance, image }) => (
  <motion.div
    whileHover={{ y: -5 }}
  ...
  const attractions = [
    {
      ...
      image: "/HighAerial.jpeg" // Replace with actual image
    },
    {
    ...
    },
    {
      ...
      description: "Enjoy year-round activities including skiing, mountain biking, and scenic lift rides.",
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="p-6 md:p-10">
              <div className="flex flex-col md:flex-row">
                <div className="md:w-1/2 mb-6 md:mb-0 md:pr-8">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">Our Marina Location</h2>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <a href="tel:406-270-6256" className="text-blue-600 font-medium">(406) 270-6256</a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <a href="mailto:bigskyparasailing@gmail.com" className="text-blue-600 font-medium">bigskyparasailing@gmail.com</a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700">May - September: 9:00 AM - 7:00 PM</p>
                ...
                <div className="md:w-1/2">
                  <div className="rounded-lg overflow-hidden shadow-lg h-full">
                    ...
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2718.5880209291873!2d-114.23062892326895!3d47.033201171235!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x535738ba42c5bfad%3A0xc467e9b9c3be7e35!2sFlathead%20Harbor%20Marina!5e0!3m2!1sen!2sus!4v1683225409729!5m2!1sen!2sus"
                      width="100%"
                      height="100%"
            ...
            <div className="bg-gray-50 p-6 flex flex-wrap justify-center gap-4">
              <a
                href="https://goo.gl/maps/ZsM5KoP5dX9wbWsDA"
                target="_blank"
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
              <motion.div variants={fadeIn} className="bg-white p-6 rounded-xl shadow-md">
                ...
                <div className="space-y-3">
                  <div className="bg-gray-50 p-3 rounded-lg">
                    <p className="font-semibold text-blue-600">From Kalispell (15 miles)</p>
                    <p className="text-sm text-gray-700">Take US-93 S for approximately 15 miles. Flathead Harbor will be on your left in Lakeside.</p>
                  </div>
                  <div className="bg-gray-50 p-3 rounded-lg">
                    <p className="font-semibold text-blue-600">From Missoula (90 miles)</p>
                    <p className="text-sm text-gray-700">Take US-93 N for approximately 90 miles. Flathead Harbor will be on your right as you enter Lakeside.</p>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div variants={fadeIn} className="bg-white p-6 rounded-xl shadow-md">
                <div className="flex items-center mb-4">
                  <div className="bg-blue-100 p-2 rounded-full mr-3">
                    <svg className="w-6 h-6 text-blue-600" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                      <path d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd"></path>
                    </svg>
                  </div>
                  <h3 className="text-xl font-bold text-gray-900">Key Distances</h3>
                </div>
                <div className="space-y-3">
                  <div className="flex justify-between items-center bg-gray-50 p-3 rounded-lg">
                    <div>
                      <p className="font-semibold text-gray-900">Kalispell</p>
                      <p className="text-sm text-gray-700">Nearest major town</p>
                    </div>
                  ...
                  <div className="flex justify-between items-center bg-gray-50 p-3 rounded-lg">
                    <div>
                      <p className="font-semibold text-gray-900">Glacier Park Int'l Airport</p>
                  ...
                  <div className="flex justify-between items-center bg-gray-50 p-3 rounded-lg">
                    <div>
                      <p className="font-semibold text-gray-900">Glacier National Park</p>
            ...
            >
              <p className="text-gray-700 mb-4">
                <span className="font-semibold">Pro Tip:</span> Look for the Flathead Harbor sign on Highway 93. The marina entrance is well-marked and there's plenty of free parking available.
              </p>
              <a
                href="https://goo.gl/maps/ZsM5KoP5dX9wbWsDA"
                target="_blank"
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              <motion.div variants={fadeIn} className="bg-gray-50 p-5 rounded-lg shadow-md">
                <div className="flex items-center mb-4">
                  <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center mr-3">
                    <svg className="w-6 h-6 text-blue-600" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                      <path d="M11.3 1.046A1 1 0 0112 2v5h4a1 1 0 01.82 1.573l-7 10A1 1 0 018 18v-5H4a1 1 0 01-.82-1.573l7-10a1 1 0 011.12-.38z" clipRule="evenodd"></path>
                    </svg>
                  </div>
                  <h3 className="text-xl font-bold text-gray-900">Marina Services</h3>
                </div>
              ...
              <motion.div variants={fadeIn} className="bg-gray-50 p-5 rounded-lg shadow-md">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-bold text-gray-900">Marina Amenities</h3>
                </div>
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-amber-500 mt-0.5 mr-2" fill="currentColor" viewBox="0 0 20 20">
              ...
              <motion.div variants={fadeIn} className="bg-gray-50 p-5 rounded-lg shadow-md">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-bold text-gray-900">Why We're Here</h3>
                </div>
                <p className="text-gray-700 mb-4">
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-cyan-500 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            >
              Contact us today to book your parasailing adventure at Flathead Harbor Marina!
            </motion.p>
