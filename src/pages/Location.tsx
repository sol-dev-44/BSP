            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
              ...
              >
                ...
                <p className="text-gray-700 mb-4">
                  Flathead Harbor Marina is easily accessible via US Highway 93,
                  which runs along the western shore of Flathead Lake.
                </p>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              ...
              >
                ...
                <p className="text-gray-700 mb-4">
                  We chose Flathead Harbor Marina for our parasailing operation
                  because it offers:
                </p>
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-start">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <motion.p
              ...
              className="text-gray-700 text-center mb-12 max-w-3xl mx-auto"
            >
              Flathead Lake and the surrounding area offer countless adventures
              beyond parasailing. Here are some must-visit attractions nearby.
            </motion.p>
