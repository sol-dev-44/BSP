...
const landingPageStructuredData = {
  ...
  "geo": {
    "@type": "GeoCoordinates",
    "latitude": 48.0411, // Lakeside, MT coordinates
    "longitude": -114.2298,
  },
  ...
  const features = [
    {
      ...
      description:
        "Soar 300 feet above Flathead Lake's crystal waters and experience panoramic mountain views.",
    ...
    },
    {
      title: "Safe & Fun",
      description:
        "Our experienced captains and state-of-the-art equipment ensure a safe and exhilarating adventure.",
    ...
    },
    {
      ...
      description:
        "Capture your incredible parasailing experience with our high-quality photo packages.",
        ...
        <div className="py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              >
                Experience Montana's premier parasailing adventure with
                unmatched views and safety.
              </motion.p>
            </motion.div>
