  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text":
          "Yes, parasailing with Big Sky Parasail is extremely safe. We maintain a perfect safety record and employ USCG certified captains with 15+ years of experience.",
      },
    },
    {
      "@type": "Question",
      "name": "Do I need to know how to swim to go parasailing?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text":
          "While knowing how to swim is recommended, it's not required. All parasailers wear a USCG-approved life jacket at all times. Our dry launch and landing system means you won't get wet unless you choose to.",
      },
    },
    {
      "@type": "Question",
      "name": "What should I wear for parasailing?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text":
          "Comfortable clothing, secure footwear, and sun protection (sunglasses, hat, sunscreen) are recommended. Since our take-offs and landings are from the boat deck, you won't get wet unless you choose a dip option.",
      },
    },
    {
      "@type": "Question",
      "name": "What is the weight limit for parasailing?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text":
          "Our minimum weight is approximately 90 pounds for solo flyers. The maximum combined weight for tandem or triple flights is 450 pounds.",
      },
    },
    {
      "@type": "Question",
      "name": "How high will I fly while parasailing?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text":
          "You'll fly approximately 300-400 feet above the water, offering spectacular views of Flathead Lake and the surrounding mountains.",
      },
    },
  ...
  const faqs = [
    {
      ...
      answer:
        "Most people find parasailing surprisingly peaceful and relaxing, not scary! The takeoff and landing are smooth and gentle. Once you're in the air, the experience is serene with amazing views. The sensation is more like floating than a thrill ride, allowing you to enjoy the scenery in a tranquil setting high above the water.",
    },
    {
      question: "Do I need to have any experience to parasail?",
      answer:
        "Absolutely no experience is necessary! Our professional crew handles all the technical aspects of the flight. You'll receive a brief safety instruction before takeoff, but there's no training required. Simply sit back, relax, and enjoy the incredible views while our experienced team does all the work.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes! We offer solo, tandem (2 people), and triple flights, depending on the combined weight of the participants. Flying together is a great way to share the experience with friends and family, and it's especially helpful for children or those who might be a bit nervous about going alone.",
    },
    {
      question: "Do you take-off from or land in the water?",
      answer:
        "We offer dry takeoffs and landings directly from our custom 31' parasail boat. You'll be securely seated on the flight deck at the back of the boat for takeoff, and our winch system will gently lift you into the air. You'll return the same way, landing smoothly back on the boat. No swimming required!",
    },
    {
      question: "Do I ever touch the water?",
      answer:
        `While our standard flights feature dry takeoffs and landings, we do offer optional "dips" for those who want to touch the water. Just let your captain know if you'd like to experience a refreshing toe dip in Flathead Lake during your flight, and they'll be happy to accommodate if conditions permit.`,
    },
    {
      question: "What can I expect to see parasailing?",
      answer:
        "You'll enjoy breathtaking 360° panoramic views of Flathead Lake and the surrounding mountain ranges. On clear days, you can see the Mission Mountains to the east, the Swan Range to the northeast, Wild Horse Island, and sometimes even glimpses of Glacier National Park in the distance. The crystal-clear waters of Flathead Lake are also amazing from above!",
    },
    {
      question: "Can we fly higher than your standard ride?",
      answer:
        "Our standard flight altitude is approximately 300-500 feet above the water, which provides the optimal balance of amazing views and safety. Due to FAA regulations and safety protocols, we maintain consistent flight altitudes for all our parasailing experiences. Rest assured, even at our standard height, the views are absolutely spectacular!",
    },
    {
      question: "What should I wear?",
      answer:
        "We recommend comfortable, weather-appropriate clothing. Swimwear beneath your clothes is a good idea (especially if you'd like to do a water dip). Secure footwear (or bare feet) is best for the boat. Don't forget sun protection: sunscreen, a hat, and sunglasses with a strap. A light jacket or windbreaker can be helpful on cooler days.",
    },
    {
      question: "Can I go along just to watch?",
      answer:
        "Yes! We offer observer rates for friends and family who want to enjoy the boat ride without parasailing. Observers can take photos, enjoy the scenery, and share in the experience from the boat. It's a great option for those who prefer to stay on the water while their companions take to the sky.",
    },
    {
      question: "How long does the excursion take?",
      answer:
        "The entire experience typically takes about 1 hour from check-in to return. This includes check-in procedures, safety briefing, boat ride to and from the parasailing area, and the flight itself. Actual flight time is approximately 10-12 minutes per group, which is the optimal duration for enjoying the experience.",
    },
    {
      question:
        "Is your company specially trained, experienced and or licensed?",
      answer:
        "Absolutely! Our captains are USCG certified with 15+ years of parasailing experience. All of our equipment meets or exceeds industry safety standards with daily inspections, and our crew is trained in CPR, first aid, and water rescue techniques.",
    },
    {
      question: "Are reservations required?",
      answer:
        "While we sometimes can accommodate walk-ins, reservations are strongly recommended, especially during peak season (June-August). Booking in advance ensures you get your preferred date and time slot. You can make reservations by calling us at (406) 270-6256 or emailing bigskyparasailing@gmail.com.",
    },
    {
      question: "How far in advance should I make a reservation?",
      answer:
        "For peak summer season (late June through August), we recommend booking 1-2 weeks in advance, especially for weekend slots or if you have a specific time preference. For holidays and special events, 3-4 weeks notice is ideal. In the shoulder seasons (May-June and September-October), a few days' notice is usually sufficient.",
    },
    {
      question:
        "What if I want to do something special with my family and friends for a birthday, anniversary, or wedding party?",
      answer:
        "We love helping you celebrate special occasions! We offer private charters where you can book the entire boat for your group. This option is perfect for birthdays, bachelor/bachelorette parties, corporate events, or family reunions. Contact us directly to discuss your specific needs and we'll work with you to create a memorable experience.",
    },
    {
  ...
  return (
    <>
      <SEO
        ...
        keywords="parasailing FAQ, Montana parasail questions, Flathead Lake parasailing information, parasailing safety, what to expect parasailing"
        ...
        <section className="py-8 bg-white">
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap justify-center gap-4">
              <a
                href="#experience"
                className="px-6 py-3 bg-blue-100 hover:bg-blue-200 text-blue-800 font-medium rounded-full transition-colors"
              >
        ...
        <section className="py-12 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              >
                We're happy to help! Contact us directly for any questions not
                covered here.
              </motion.p>
              <motion.div
                variants={fadeInUp}
        ...
        <section className="py-16 bg-gradient-to-r from-blue-600 to-cyan-500 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              >
                Book your parasailing adventure today and create unforgettable
                memories on Flathead Lake!
              </motion.p>
